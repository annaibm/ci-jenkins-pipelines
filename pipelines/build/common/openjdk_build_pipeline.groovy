                ...
                testStages["${testType}"] = {
                    ...
                    context.stage("${testType}") {
                        ...
                        if (fipsTestBuildSuffix.trim()) {
							...
							// Apply shortened FIPS suffixes to match aqaTestPipeline.groovy naming
							def shortSuffix = fipsTestBuildSuffix.toLowerCase()
							if (shortSuffix == "fips140_2") {
								shortSuffix = "f2"
							} else if (shortSuffix == "fips140_3_openjceplusfips.fips140-3-strongly-enforced") {
								shortSuffix = "f3_strong"
							} else if (shortSuffix == "fips140_3_openjceplusfips.fips140-3") {
								shortSuffix = "f3_strict"
							} else if (shortSuffix == "fips140_3_openjceplusfips") {
								shortSuffix = "f3_weak"
							}
							jobParams.put('TEST_JOB_NAME', "${jobParams.TEST_JOB_NAME}_${shortSuffix}")
						}
